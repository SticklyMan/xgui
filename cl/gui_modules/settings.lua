...
------------
	local xgset_ULX = x_makepanelist{ x=200, y=30, w=190, h=335, spacing=1, padding=0, parent=xgui_settings, autosize=false }
...
------------
	local xgset_GUI = x_makepanelist{ x=395, y=30, w=190, h=200, spacing=1, padding=0, parent=xgui_settings, autosize=false }
