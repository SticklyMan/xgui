...
------------
	local xgui_general = x_makepanelist{ x=5, y=30, w=190, h=335, spacing=1, padding=0, parent=xgui_settings, autosize=false }
		...
		xgui_general:AddItem( x_makecat{ label="Gamemode Settings", contents=xgui_general_cat1, parent=xgui_general } )
		...
		xgui_general:AddItem( x_makecat{ label="Server Settings", contents=xgui_general_cat2, parent=xgui_general } )
		...
		xgui_general:AddItem( x_makecat{ label="Misc Settings", contents=xgui_general_cat3, parent=xgui_general } )
------------
	local xgui_ULX = x_makepanelist{ x=200, y=30, w=190, h=335, spacing=1, padding=0, parent=xgui_settings, autosize=false }
		local xgui_ULX_cat1 = x_makepanelist{ autosize=true }
			...
			xgui_advert_button.DoClick = function()
				...
				x_makebutton{ x=10, y=190, w=120, h=20, label="Add...", parent=xgui_advert }.DoClick = function()
					...
					xgui_add_list:AddItem( x_makecat{ label="CSay Settings", contents=xgui_add_csay } )
				end
		...
		xgui_ULX:AddItem( x_makecat{ label="ULX Settings", contents=xgui_ULX_cat1 } )
		...
		xgui_ULX:AddItem( x_makecat{ label="Vote Settings", contents=xgui_ULX_cat2 } )
		...
		xgui_ULX:AddItem( x_makecat{ label="Logging Settings", contents=xgui_ULX_cat3 } )
		...
		xgui_ULX:AddItem( x_makecat{ label="Reserved Slots", contents=xgui_ULX_cat4 } )
...
------------
	local xgui_GUI = x_makepanelist{ x=395, y=30, w=190, h=200, spacing=1, padding=0, parent=xgui_settings, autosize=false }
		...
		xgui_GUI:AddItem( x_makecat{ label="XGUI Settings", contents=xgui_GUI_cat1 } )
