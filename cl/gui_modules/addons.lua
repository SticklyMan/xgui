...
function xgui_load_addons()
	hook.Call( "xgui_addon" )
end
hook.Add( "PlayerInitialSpawn", "xgui_load_addons", xgui_load_addons )


function xgui_tab_addons()
	xgui_addons = vgui.Create( "DPanel" )
------------
	xgui_addon_panel = x_makepanelist{ x=10, y=30, w=570, h=330, parent=xgui_addons, autosize=false }
	xgui_addon_panel.Paint = function() end
